...
* select the most supported model (including or excluding covariates, changing the autocovariance functions).
* predict the *C16* over the prediction locations using your model.
